...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["geographic_node.id"], name="fk_geographic_node_parent"
        ),
        sa.ForeignKeyConstraint(
            ["root_id"], ["geographic_node.id"], name="fk_geographic_node_root"
        ),
        sa.ForeignKeyConstraint(
            ["legacy_country_id"],
            ["country.id"],
            name="fk_geographic_node_legacy_country",
        ),
        sa.ForeignKeyConstraint(
            ["legacy_area_one_id"],
            ["area_one.id"],
            name="fk_geographic_node_legacy_area_one",
        ),
        sa.ForeignKeyConstraint(
            ["legacy_area_two_id"],
            ["area_two.id"],
            name="fk_geographic_node_legacy_area_two",
        ),
        sa.ForeignKeyConstraint(
            ["legacy_locality_id"],
            ["locality.id"],
            name="fk_geographic_node_legacy_locality",
        ),
    ...
    op.create_unique_constraint(
        "uq_geographic_node_parent_short_name",
        "geographic_node",
    ...
    op.add_column(
        "dive_shop", sa.Column("geographic_node_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
        "dive_shop_geographic_node_id_fkey",
        "dive_shop",
        "geographic_node",
        ["geographic_node_id"],
        ["id"],
...
def downgrade():
    ...
    op.drop_constraint(
        "dive_shop_geographic_node_id_fkey", "dive_shop", type_="foreignkey"
    )
